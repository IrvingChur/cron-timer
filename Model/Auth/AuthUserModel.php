...
class AuthUserModel extends BaseModel
{
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
     */
    public function qaLevel()
    {
        return $this->hasOne(QaUserLevelModel::class, 'user_id', 'id');
    }
    ...
    {
        return $this->hasOne(AuthTeacherQualificationModel::class, "user_id", "id");
    }
    ...
    public function jin()
    {
        return $this->hasOne(AuthUserJinModel::class, 'user_id');
    }
}